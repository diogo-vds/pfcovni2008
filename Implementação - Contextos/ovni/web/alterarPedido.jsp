...
<br><br>
			...
			<form name="frmAlterar" method="post" action="/ovni/AlterarPedido">
				...
				<input type="hidden" name="CodigoPedido" value="<%=Pedido%>"><br>
				<input type="radio" name="rdPago" value="Pago">Pago<br>
				<input type="radio" name="rdPago" value="NaoPago">Nao Pago<br>
					<select name="Status">
<%
