...
<%
	Vector pedidos = (Vector) session.getAttribute("cliBuscarPedido");
%>
...
function detalhes(posi)
{
    ...
    <head>
        ...
        <title>OVNI.net - Ofertas de outro mundo : Pesquisa de pedidos</title>
		<style>
...
<table style="width:100%">
    ...
    <div id="principal">
        ...
        <div id="content_full">  
		 <%@ include file="/loggin/buscaPedido.jsp" %>
...
<%
	if (pedidos != null)
	{
		...
		{
%>
			<form name="frmDetalhes" method="post" action="/ovni/PesquisarPedido">
